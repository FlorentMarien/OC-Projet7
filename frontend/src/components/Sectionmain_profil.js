...
function Sectionmain_profil({
    ...
    function galleryDisplayButton(e, boolLeave) {
        ...
        if (boolLeave === false) {
            if (targetRechercheUser.userid === auth[1]) {
                document.getElementById('button-gallery').style.visibility =
                    'visible';
            }
                ...
                for (let x = 0; x < listMessage.length; x++) {
                    if (listMessage[x].userId !== undefined) {
                        listmessageprofil = (
                            <>
                                ...
                                <div className="listMessage">
                                    {
                                        <Message
                                            key={listMessage[x]._id}
                                            parametre={parametre}
                                            element={listMessage[x]}
                                            auth={auth}
                        ...
                        for (let y = 0; y < 2; y++) {
                            if (y === 1) {
                                nbranswer =
                                    listMessage[x].answerArray[y].length;
                                for (
                                    let z = 0;
                                    z < listMessage[x].answerArray[y].length;
                                    z++
                                ) {
                                    ...
                                    for (
                                        let w = 0;
                                        w <
                                        listMessage[x].answerArray[z + 2]
                                            .length;
                                        w++
                                    ) {
                                        if (
                                            listMessage[x].answerArray[z + 2][w]
                                                .userId ===
    ...
    async function getmes() {
        return await getuserMessageApi(
            JSON.stringify({
                ...targetRechercheUser,
        ...
        timer = setInterval(() => {
            if (document.getElementById('img-userfocusgallery') !== null) {
                ...
                if (profilTarget.imageArray[posimg + 1] !== undefined) {
                    document.getElementById('img-userfocusgallery').src =
                        profilTarget.imageArray[posimg + 1];
                } else {
                    document.getElementById('img-userfocusgallery').src =
                        profilTarget.imageArray[0];
                }
            }
        }, 2000);
        return () => {
                ...
                <>
                    <div id="blockprofil">
                        <div
                            id="usergallery"
                            onMouseEnter={(e) => {
                                galleryDisplayButton(e, false);
                            }}
                            onMouseLeave={(e) => {
                                galleryDisplayButton(e, true);
                            }}
                        >
                            <div id="img-gallery">
                                {profilTarget.imageArray.length !== 0 ? (
                                    <>
                                        <img
                                            id="img-userfocusgallery"
                                            src={profilTarget.imageArray[0]}
                                            alt={profilTarget.name}
                                        />
                                    </>
                                ) : (
                                    <IconButton>
                        ...
                        <div className="userprofil">
                            {profilTarget[0] !== 0 && (
                                <>
                                    <img
                                        src={profilTarget.imageUrl}
                                        alt={profilTarget.name}
                                    />
                                    <ul>
                                        <li>
                                            Nom: {profilTarget.name} Prenom:{' '}
                                            {profilTarget.prename}
                                        </li>
                                        <li>
                                            <span>
                                                Message:{' '}
