        ...
        userList.forEach((element) => {
            reply = (
                <>
                    ...
                    <Button
                        variant="contained"
                        className="recherche_user"
                        onClick={(e) => {
                            settargetRechercheUser({
                                userid: element._id,
                                emetteur: 'navbar-aside',
                            });
                        }}
                    >
                        <div>
                            <img
                                ...
                                alt={element.name + ' ' + element.prename}
                            />
                        </div>
                        <div>
            ...
            <div className="aside_recherche">
                <ThemeProvider theme={theme}>
                    <TextField
                        ...
                        color="neutral"
                        type="text"
                        id="formAsideRecherche"
                        label="Recherche"
                        defaultValue={formuserRecherche}
                        onChange={(e) => {
                            getRechercheuser(e, e.target.value);
                        }}
                    />
                </ThemeProvider>
                <div className="aside_recherche_result">
                    {userList[0] !== null && Writeuserrecherche()}
                </div>
            </div>
        </aside>
    );
